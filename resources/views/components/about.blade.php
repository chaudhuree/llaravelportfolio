            ...
            <div class="col-xxl-8">
                <div class="text-center my-5">
                    ...
                    <div class="d-flex justify-content-center fs-2 gap-4">
                        <a id="twitter" class="text-gradient" ><i class="bi bi-twitter"></i></a>
                        <a id="linkedin" class="text-gradient" ><i class="bi bi-linkedin"></i></a>
                        <a id="github" class="text-gradient" ><i class="bi bi-github"></i></a>
                    </div>
                </div>
            </div>
        </div>
